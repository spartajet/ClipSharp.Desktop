...
internal static class NativeMethods
{
    ...
    [DllImport("user32",EntryPoint = "EnumClipboardFormats", SetLastError = true)]
    ...
    internal static extern int GetClipboardFormatName(uint format, out string lpszFormatName, int cchMaxCount);
    ...
    /// </returns>
    [DllImport("shell32")]
    internal static extern int DragQueryFile(IntPtr hDrop, uint iFile, out string lpszFile, int cch);
